    ...
    function GetPreNext($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            if(is_array($preRow))
            {
                ...
                $this->PreNext['pre'] = "<li class='previous'><a href='$mlink'>上一篇<span aria-hidden='true' class='hidden-xs'>：{$preRow['title']}</span></a></li> ";
                $this->PreNext['preimg'] = "<a href='$mlink'><img src=\"{$preRow['litpic']}\" alt=\"{$preRow['title']}\"/></a> ";
            }
            else
            {
                $this->PreNext['pre'] = "<li class='previous disabled'><a href='#'>上一篇<span aria-hidden='true' class='hidden-xs'>：没有了</span></a></li> ";
            ...
            if(is_array($nextRow))
            {
                ...
                $this->PreNext['next'] = "<li class='next'><a href='$mlink'>下一篇<span aria-hidden='true' class='hidden-xs'>：{$nextRow['title']}</span></a></li> ";
                $this->PreNext['nextimg'] = "<a href='$mlink'><img src=\"{$nextRow['litpic']}\" alt=\"{$nextRow['title']}\"/></a> ";
            }
            else
            {
                $this->PreNext['next'] = "<li class='next disabled'><a href='#'>下一篇<span aria-hidden='true' class='hidden-xs'>：没有了</span></a></li>";
